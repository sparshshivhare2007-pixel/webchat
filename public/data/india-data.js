const INDIA_DATA = {
    ...
    'andhra-pradesh': {
        name: 'Andhra Pradesh',
        districts: ['Anantapur', 'Chittoor', 'East Godavari', 'Guntur', 'Kadapa', 'Krishna', 'Kurnool', 'Nellore', 'Prakasam', 'Srikakulam', 'Visakhapatnam', 'Vizianagaram', 'West Godavari', 'Palnadu', 'NTR', 'Konaseema', 'Alluri Sitharama Raju', 'Anakapalli', 'Kakinada', 'Eluru', 'Machilipatnam', 'Bapatla']
    },
    'telangana': {
        name: 'Telangana',
    ...
    'nagaland': {
        name: 'Nagaland',
        districts: ['Dimapur', 'Kiphire', 'Kohima', 'Longleng', 'Mokokchung', 'Mon', 'Peren', 'Phek', 'Tuensang', 'Wokha', 'Zunheboto', 'Chumoukedima', 'Niuland', 'Shamator', 'Tseminyu']
    },
    'sikkim': {
        name: 'Sikkim',
        districts: ['East Sikkim', 'North Sikkim', 'South Sikkim', 'West Sikkim', 'Pakyong', 'Soreng', 'Namchi', 'Gangtok', 'Mangan', 'Gyalshing']
    },
    'tripura': {
        name: 'Tripura',
